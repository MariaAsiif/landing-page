...
const Inputs = () => {
  ...
  const handleChangeCountryStateCity = (e) => {
      ...
      <div className='container mb-4'>
        <div className='row'>
          ...
          <div className='col-lg-2 d-flex align-items-center justify-content-around'>
            ...
            <button onClick={() => setservicePopup(true)} style={{ fontSize: 16, fontWeight: "600" }} className='btn btn-danger h-100'>Add Service</button>
          </div>
